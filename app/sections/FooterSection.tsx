...
export default function FooterSection() {
  ...
  return (
    <footer className="border-t border-blue-900/40 bg-black/30 px-3 sm:px-4 py-10 sm:py-12 md:py-16 w-full flex flex-col items-center">
      <div className="max-w-6xl mx-auto w-full px-2">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-white font-bold text-xs sm:text-sm md:text-base">Al-Amir Islamic Center</span>
            </div>
            <p className="text-gray-500 text-xs leading-relaxed">
              A house of Allah for worship, learning, and community — serving South Florida with sincerity and
              compassion.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1.5 md:space-y-2 text-xs text-gray-500">
              ...
              <div className="pt-2 text-accent/60 text-xs">Jumu&apos;ah every Friday · 1:15 PM</div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-blue-900/20 pt-4 md:pt-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-accent/60 text-xs">سُبْحَانَ اللَّهِ وَبِحَمْدِهِ</p>
        </div>
      </div>
    </footer>
  );
